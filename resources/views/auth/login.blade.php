    ...
    <div class="auth-card">
        ...
        <form method="POST" action="{{ route('login') }}" x-data="{ showPassword: false }">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                <label for="remember_me" style="display: flex; align-items: center; cursor: pointer; color: #8b949e; font-size: 0.85rem;">
                    <input id="remember_me" type="checkbox" name="remember" style="margin-right: 8px; background: #0d1117; border-color: #30363d; border-radius: 4px;">
                    Keep me logged in
                </label>
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" style="color: #6366f1; font-size: 0.85rem; font-weight: 600;">Forgot password?</a>
                @endif
            </div>

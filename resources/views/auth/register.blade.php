<x-guest-layout>
    <div style="background:white;padding:48px;border-radius:24px;box-shadow:0 20px 40px -10px rgba(0,0,0,0.1);">
        <div style="text-align:center;margin-bottom:32px;">
            <h2 style="font-size:2rem;font-weight:800;color:#111827;margin-bottom:8px;">Create an Account</h2>
            <p style="color:#6b7280;font-size:1rem;">Join ThreadSpace today.</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div style="margin-bottom:20px;">
                <label for="name" style="display:block;font-size:.9rem;font-weight:700;color:#374151;margin-bottom:8px;">Full Name</label>
            ...
            <div style="margin-bottom:24px;">
                <label for="password_confirmation" style="display:block;font-size:.9rem;font-weight:700;color:#374151;margin-bottom:8px;">Confirm Password</label>
            ...
            <div style="text-align:center;font-size:.95rem;color:#4b5563;margin-bottom:24px;">
                Already have an account? <a href="{{ route('login') }}" style="color:#4f46e5;font-weight:700;text-decoration:none;">Log In</a>
            </div>

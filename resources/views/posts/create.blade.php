    ...
    <div class="create-split-container">
        ...
        <div class="create-left">
            ...
            <div style="position: absolute; inset: 0; background: linear-gradient(to top, rgba(13, 17, 23, 0.9) 0%, transparent 80%); display: flex; flex-direction: column; justify-content: flex-end; padding: 32px;">
                <h2 style="color: rgba(255,255,255,0.9); font-size: 1.8rem; font-weight: 400; line-height: 1.2; margin-bottom: 8px; letter-spacing: -0.5px;">Contribute to c/{{ $community->name }}.</h2>
                <p style="color: rgba(255,255,255,0.5); font-size: 0.95rem; font-weight: 300; line-height: 1.5; margin: 0;">Share your perspective and ignite discussions.</p>
            </div>
        </div>
        ...
        <div class="create-right">
            <div style="margin-bottom: 20px;">
                ...
                <p style="font-size: 0.85rem; font-weight: 400; color: #6e7681; margin: 0;">Posting directly in c/{{ $community->name }}.</p>
            </div>

            <form action="{{ route('communities.posts.store', $community) }}" method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 16px;">
                @csrf
